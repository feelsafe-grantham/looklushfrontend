  ...
  return (
    <>
      ...
      <div className="grid gap-5">
        ...
        <SectionHeading
          isHeading
          line1="Premier Aesthetic Clinic in Ghaziabad"
          line2="for Flawless Glow"
        />
        <SectionHeadPara para="Our ghaziabad clinic offers cutting-edge treatments in a serene, discreet space—designed for clients who value both expertise and comfort." />
